...
use range_finder::{TofSensor, Prox4040Sensor};
...
impl_components!(Lights,HouseLight,StepperMotor,PeckboardKeys,FinchboardKeys,AlsaPlayback,TofSensor,Prox4040Sensor,MonoLed,RGBLed,GpioSwitch);
